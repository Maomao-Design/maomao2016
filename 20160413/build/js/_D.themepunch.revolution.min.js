/**************************************************************************
 * DM.themepunch.revolution.js - DM Plugin for Revolution Slider
 * @version: 4.6.4 (26.11.2014)
 * @requires DM v1.7 or later (tested on 1.9)
 * @author ThemePunch
**************************************************************************/

function revslider_showDoubleDMError(e) {
    var t = "Revolution Slider Error: You have some DM.js library include that comes after the revolution files js include.";
    t += "<br> This includes make eliminates the revolution slider libraries, and make it not work.";
    t += "<br><br> To fix it you can:<br>&nbsp;&nbsp;&nbsp; 1. In the Slider Settings -> Troubleshooting set option:  <strong><b>Put JS Includes To Body</b></strong> option to true.";
    t += "<br>&nbsp;&nbsp;&nbsp; 2. Find the double DM.js include and remove it.";
    ...
    function r(r, i) {
        ...
        if (!r.hasClass("revslider-initialised")) {
            ...
            S = parseFloat(b[2] || "0");
            if (w == 1 && E < 7) {
                r.html('<div style="text-align:center; padding:40px 0px; font-size:20px; color:#992222;"> The Current Version of DM:' + b + " <br>Please update your DM Version to min. 1.7 in Case you wish to use the Revolution Slider Plugin</div>")
            }
            if (w > 1) i.ie = false;
