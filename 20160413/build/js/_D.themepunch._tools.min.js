...
/*
* @fileOverview TouchSwipe - DM Plugin
* @version 1.6.6
*
* @author Matt Bryson http://www.github.com/mattbryson
* @see https://github.com/mattbryson/TouchSwipe-DM-Plugin
* @see http://labs.skinkers.com/touchSwipe/
* @see http://plugins.DM.com/project/touchSwipe
* 
...
(function(a) {
    ...
    f.fn.swipe = function(G) {
        ...
        if (E && typeof G === "string") {
            if (E[G]) {
                ...
                f.error("Method " + G + " does not exist on DM.swipe")
            }
        } else {
    ...
    function C(a4, av) {
        ...
        try {
            ...
            f.error("events not supported " + J + "," + aD + " on DM.swipe")
        }
        ...
        this.option = function(bc, bb) {
            if (av[bc] !== undefined) {
                ...
                f.error("Option " + bc + " does not exist on DM.swipe.options")
            }
            return null
        };
        function aN(bd) {
...
(function(t, e) {
    ...
    if (!i.TweenLite) {
        ...
        function(e, i, s) {
            ...
            var r, n, a, o = e.DM || e.length && e !== t && e[0] && (e[0] === t || e[0].nodeType && e[0].style && !e.nodeType),
